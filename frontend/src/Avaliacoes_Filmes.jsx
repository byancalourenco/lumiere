                    ...
                    <div class="Retangulo_Azul">
                        <div className="Grid_Ret_Azul">
                            <div className="Left_Box_Ret_Azul">
                                <img src="/src/assets/img/LA_land.png" alt="logo" className="Harry_Potter_IMG"/>
                            </div>
                            <div className="Right_Box_Ret_Azul">
                                <div class="row_Ret_Azul">
                                    <div className="Text_Ret_Azul">
                                        <h3 className="h3_noblue">La La Land: Cantando Estações</h3>
                                    </div>
                                </div>
                                <div class="row_Ret_Azul">
                                ...
                                <div class="row_Ret_Azul">
                                    <h5 className="h5_noblue">Diretor: Damien Chazelle</h5>
                                </div>
                                <div class="row_Ret_Azul">
                                    <h5 className="h5_noblue">Genêro: Romance musical</h5>
                                </div>
                                <div class="row_Ret_Azul">
                                    <h5 className="h5_noblue">Lançamento: 13 de janeiro de 2017</h5>
                                </div>
                            </div>
                       </div>
                    </div>
                    ...
                    <div class="Retangulo_Cinza">
                        <div class="Grid_Av_L">
                            <div class="Scd_Grid_Av_L">
                                ...
                                <div class="Button_L">
                                    <Link className="btn-L" to="/detalhada/filme">Faça uma avaliação detalhada</Link>
                                </div>
                            </div>
                            <div class="box_L">
                                <ul class="bullet-list">
...
export default Avaliacoes_Filmes;